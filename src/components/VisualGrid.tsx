...
export const VisualGrid = (props) => {
    ...
    return <div className={"py-1 px-2 mb-2 bg-gray-100 dark-mode:bg-mono-700 text-gray-500 dark-mode:text-mono-100 rounded-sm border border-b-2 border-gray-500 dark-mode:border-mono-500"}>
